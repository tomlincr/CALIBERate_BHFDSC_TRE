...
# MAGIC  
# MAGIC **Date last run** 2021-07-14
# MAGIC 
# MAGIC **Changelog**  
# MAGIC 0. `21-07-14` **Initial version**
# MAGIC 
# MAGIC **Data input**  
...
dictionary.createOrReplaceGlobalTempView("ccu013_caliber_category_mapping")
# drop_table("ccu013_caliber_category_mapping") 
create_table("ccu013_caliber_category_mapping") 
...
# MAGIC %md
# MAGIC # 3. Apply mapping to categorise `ccu013_caliber_patients`

# COMMAND ----------

patients = spark.table("dars_nic_391419_j3w9t_collab.ccu013_caliber_patients") 

# COMMAND ----------

dictionary = spark.sql("SELECT phenotype, category FROM dars_nic_391419_j3w9t_collab.ccu013_caliber_category_mapping").toPandas()
...
patients = patients.withColumn("category", mapping_expr[col("phenotype")])

# COMMAND ----------

patients.createOrReplaceGlobalTempView("ccu013_caliber_patients_category_code")

# COMMAND ----------

# MAGIC %md
# MAGIC # 5. Summary counts
...
# MAGIC SELECT
# MAGIC   category,
# MAGIC   COUNT(distinct code)
# MAGIC FROM
# MAGIC   global_temp.ccu013_caliber_patients_category_code
# MAGIC GROUP BY
# MAGIC   category
...
# MAGIC   COUNT(distinct code)
# MAGIC FROM
# MAGIC   dars_nic_391419_j3w9t_collab.ccu013_caliber_patients
# MAGIC GROUP BY
# MAGIC   phenotype
